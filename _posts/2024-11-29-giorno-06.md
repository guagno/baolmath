...
**Nota**: La relazione di divisibilità $a=_{1} b$ gode della proprietà 1 (per ogni $ n\in \mathbb{N}: n\|n $ ). Gode pure della proprietà 3.  ($k\|n\|m $ allora $ k\|m $). Ma non gode della proprietà 2 ($ 3\|6 $ ma non $ 6\|3 $). Quindi non è una relazione di equivalenza.
